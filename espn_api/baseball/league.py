...
class League(object):
    ...
    def __init__(self, league_id: int, year: int, espn_s2=None, swid=None, username=None, password=None, save_cookies=False, debug=False):
        ...
        if year < 2018:
            self.ENDPOINT = "https://fantasy.espn.com/apis/v3/games/flb/leagueHistory/" + str(league_id) + "?seasonId=" + str(year)
        else:
            self.ENDPOINT = "https://fantasy.espn.com/apis/v3/games/flb/seasons/" + str(year) + "/segments/0/leagues/" + str(league_id)
        self.teams = []
